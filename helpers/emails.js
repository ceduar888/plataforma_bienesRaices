...
const emailRegistro = async (datos) => {
    ...
    const transport = nodemailer.createTransport({
      ...
      await transport.sendMail({
        ...
        Confirma tu cuenta en el siguiente enlace: ${process.env.BACKEND_URL}/auth/confirmar/${token}
        ...
        html: `
            ...
            <a href="${process.env.BACKEND_URL}/auth/confirmar/${token}" target="_blank">
...
const emailRecuperarPassword = async (datos) => {
  ...
  const transport = nodemailer.createTransport({
    ...
    await transport.sendMail({
      ...
      ${process.env.BACKEND_URL}/auth/olvide-password/${token}
